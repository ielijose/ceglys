<?php 
  ...
  switch ($action) {
    case 'validarcodigo':
      $continuar = false;
      $codigo = $_POST['codigo'];
      $original = "ec85d01527a3ecd21d071fec36ae2c6f";
      if(md5($codigo) == $original){
        $continuar = true;
      }
    ...
    case 'registrodocente':
      ...
      if($count){
        ...
        $insertSQL = sprintf("INSERT INTO usuarios (nombre, ci, usuario, password, tipo) VALUES (%s, %s, %s, %s, 'profesor')",
        ...
        header("Location: exito.php?ref=docente");
      }
              ...
              <?php }else{ ?>          
                  <form action="?" method="POST" style="width:400px; margin:0 auto;">
                    ...
                    <table align="center" >
                      <tr>
                        <td>
                            <h6>  Ingrese el Código <br>de registro Docente</h6>
                        </td>
                        <td width="30">&nbsp;</td>
                        <td>
                          <input type="password" name="codigo" placeholder="Código Docente">
                        </td>
                      </tr>
                      <tr>
                        <td colspan="3" align="center"><input type="submit" value="Validar"></td>
                      </tr>
                    </table>
