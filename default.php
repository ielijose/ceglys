...
<div id="container">
  ...
  <div id="breadcrumbs">
    ...
    <p>Website <strong><?php print $host; ?></strong> has been successfully installed on
  ...
  <div id="listingcontainer">
	...
	<div><a href="<?php=$dotdotdir;?>" class="<?php=$class;?>"><img src="http://www.000webhost.com/images/index/dirup.png" alt="Folder" /><strong>..</strong> <em>-</em> <?php=date ("M d Y h:i:s A", filemtime($dotdotdir));?></a></div>
	...
	<div><a href="<?php=$leadon.$dirs[$i];?>" class="<?php=$class;?>"><img src="http://www.000webhost.com/images/index/folder.png" alt="<?php=$dirs[$i];?>" /><strong><?php=$dirs[$i];?></strong> <em>-</em> <?php=date ("M d Y h:i:s A", filemtime($leadon.$dirs[$i]));?></a></div>
	...
	<div><a href="<?php=$fileurl;?>" class="<?php=$class;?>"<?php=$thumb2;?>><img src="http://www.000webhost.com/images/index/<?php=$icon;?>" alt="<?php=$files[$i];?>" /><strong><?php=$filename;?></strong> <em><?php=round(filesize($leadon.$files[$i])/1024);?>KB</em> <?php=date ("M d Y h:i:s A", filemtime($leadon.$files[$i]));?><?php=$thumb;?></a></div>
